  ...
  return (
    <nav className="relative max-w-3xl mx-auto w-full px-6 py-4">
      <div className="flex items-center justify-between">
        <Link href="/" className="font-mono text-sm text-ink" onClick={() => setIsOpen(false)}>
          Timothy Sheu
        </Link>

        <div className="hidden md:flex items-center gap-6">
          <Link href="/" className="text-sm text-ink hover:text-accent transition-colors">
            Home
          </Link>
          ...
          <div className="flex items-center gap-4 pl-4 border-l border-ink/10">
            <a href="https://github.com/timjs42/personal-portfolio-site" target="_blank" rel="noopener noreferrer" aria-label="View source code for this site">
              <svg className="w-5 h-5 text-ink hover:text-accent transition-colors" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                <polyline points="16 18 22 12 16 6" />
                <polyline points="8 6 2 12 8 18" />
              </svg>
            </a>
            <a href="https://github.com/timjs42" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <svg className="w-5 h-5 text-ink hover:text-accent transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/in/timothy-sheu-6b1719220/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg className="w-5 h-5 text-ink hover:text-accent transition-colors" fill="currentColor" viewBox="0 0 24 24">
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col gap-4 pt-4 pb-2">
          <Link href="/" onClick={() => setIsOpen(false)} className="text-sm text-ink hover:text-accent transition-colors">
            Home
          </Link>
          ...
          <div className="flex items-center gap-4 pt-2 border-t border-ink/10">
            <a href="https://github.com/timjs42/personal-portfolio-site" target="_blank" rel="noopener noreferrer" aria-label="View source code for this site">
              <svg className="w-5 h-5 text-ink" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                <polyline points="16 18 22 12 16 6" />
                <polyline points="8 6 2 12 8 18" />
              </svg>
            </a>
